...
// readline.question('Please enter a word', word => {
...
// readline.question('Please enter a word', word => {
//   console.log(`Here is your word backwards: ${word.split("").reverse().join("")}!`);
//   readline.close();
// });
...
// readline.question('Enter a number! Pretty Pretty Please.', number => {
//   if (number < 0) {
